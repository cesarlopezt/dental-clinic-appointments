...
from .views import (
    ...
    PatientUpdateView, PatientDetailView, DentistListView,
    AppointmentListView, AppointmentDetailView, AppointmentCreateView,
    AppointmentDeleteView, AppointmentUpdateView
)
